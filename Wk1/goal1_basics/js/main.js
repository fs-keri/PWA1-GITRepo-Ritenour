 ...
 ********************************************/
    ...
    console.log("My Array Sum: ", myArr1[0] + myArr1[1] + myArr1[2] + myArr1[3]);
 ...
 */
    ...
    if("a" < "b"){
        ...
        //FALSE: run code
        console.log("if-else: the 'IF' statement if false");
    }
    ...
    if("a" === "a"){  //if you want this to be false then change to !==
        if ("b" === "b"){
